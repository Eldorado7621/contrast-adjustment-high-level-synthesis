...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { inStream_TVALID { I 1 bit } inStream_TDATA { I 8 vector } } \
} "
} else {
...
set InstName doHist_flow_control_loop_pipe_sequential_init_U
set CompName doHist_flow_control_loop_pipe_sequential_init
