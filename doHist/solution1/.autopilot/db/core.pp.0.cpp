...
__attribute__((sdx_kernel("doHist", 0))) void doHist(hls::stream<uint_8_side_channel> &inStream, int histo[256]);
# 3 "core.cpp" 2

__attribute__((sdx_kernel("doHist", 0))) void doHist(hls::stream<uint_8_side_channel> &inStream, int histo[256])
{_ssdm_SpecArrayDimSize(histo, 256);
#pragma HLSDIRECTIVE TOP name=doHist
# 5 "core.cpp"
...
#pragma HLS INTERFACE bram port=histo
 ...
 VITIS_LOOP_12_1: for(int idxHist=0; idxHist<256; idxHist++)
 {
#pragma HLS PIPELINE
 histo[idxHist]=0;
 }
 ...
 VITIS_LOOP_19_2: for(int idxPixel=0; idxPixel<(320*240);idxPixel++)
 {
