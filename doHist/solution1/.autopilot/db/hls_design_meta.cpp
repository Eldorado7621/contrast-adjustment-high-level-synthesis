...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("histo_Addr_B", 32, hls_out, 7, "bram", "MemPortADDR2", 1),
	Port_Property("histo_EN_B", 1, hls_out, 7, "bram", "MemPortCE2", 1),
	Port_Property("histo_WEN_B", 4, hls_out, 7, "bram", "MemPortWE2", 1),
	Port_Property("histo_Din_B", 32, hls_out, 7, "bram", "MemPortDIN2", 1),
	Port_Property("histo_Dout_B", 32, hls_in, 7, "bram", "MemPortDOUT2", 1),
	Port_Property("histo_Clk_B", 1, hls_out, 7, "bram", "mem_clk", 1),
	Port_Property("histo_Rst_B", 1, hls_out, 7, "bram", "mem_rst", 1),
