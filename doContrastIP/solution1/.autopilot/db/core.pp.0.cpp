...
# 2 "<built-in>" 2
# 1 "doContrastIP/core.cpp" 2


# 1 "doContrastIP/core.h" 1
...
# 4 "doContrastIP/core.h" 2
typedef ap_axiu<8,2,5,6> uint_8_side_channel;

__attribute__((sdx_kernel("doContrast", 0))) void doContrast(hls::stream<uint_8_side_channel> &inStream,hls::stream<uint_8_side_channel> &outStream,unsigned char xMin, unsigned char xMax);
# 4 "doContrastIP/core.cpp" 2

__attribute__((sdx_kernel("doContrast", 0))) void doContrast(hls::stream<uint_8_side_channel> &inStream,hls::stream<uint_8_side_channel> &outStream,unsigned char xMin, unsigned char xMax)
{
#pragma HLSDIRECTIVE TOP name=doContrast
# 6 "doContrastIP/core.cpp"
...
#pragma HLS INTERFACE s_axilite port=xMax bundle=ctrl_bus
 ...
 float histRange=xMax-xMin;
  ...
  VITIS_LOOP_18_1: for(int idxPixel=0; idxPixel<(320*240);idxPixel++)
  {
#pragma HLS PIPELINE
