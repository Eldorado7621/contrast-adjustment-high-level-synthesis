...
set name doContrast_sitofp_32s_32_6_no_dsp_1
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 24 \
			corename doContrast_ctrl_bus_axilite \
			name doContrast_ctrl_bus_s_axi \
			ports {$port_ctrl_bus} \
			op interface \
			interrupt_mode none \
			is_flushable 0 \
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler doContrast_ctrl_bus_s_axi BINDTYPE interface TYPE interface_s_axilite
}
...
# RegSlice definition:
set ID 39
set RegSliceName doContrast_regslice_both
set RegSliceInstName doContrast_regslice_both_U
set CoreName ap_simcore_doContrast_regslice_both
if {${::AESL::PGuard_rtl_comp_handler}} {
