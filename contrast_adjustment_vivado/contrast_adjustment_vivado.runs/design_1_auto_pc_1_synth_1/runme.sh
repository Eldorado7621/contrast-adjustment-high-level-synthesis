...
HD_PWD='/home/sam/git_workspace/contrast-adjustment-high-level-synthesis/contrast_adjustment_vivado/contrast_adjustment_vivado.runs/design_1_auto_pc_1_synth_1'
cd "$HD_PWD"
